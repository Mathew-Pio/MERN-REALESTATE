    ...
    <main className='p-3 max-w-4xl mx-auto'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
        <div className='flex flex-col gap-4 flex-1'>
          <input onChange={handleChange} value={formData.name} type='text' placeholder='name' className="border p-3 rounded-lg" id='name' maxLength="80" minLength='3' required />
        ...
        <div className='flex flex-wrap gap-6'>
          ...
          <div className='flex items-center gap-4'>
            <input onChange={handleChange} value={formData.discountPrice} type='number' id='discountPrice' className='p-3 border border-gray-300 rounded-lg' min='0' required />
            <div className='flex flex-col items-center'>
              <p>Discount Price</p>
              <span className='text-xs'>($ / month)</span>
            </div>
