...
export default function Search() {
    ...
    useEffect(() => {
        ...
        const fetchListings = async () => {
            ...
            const res = await fetch(`/api/listing/get/listingBySearch?${searchQuery}`);
            ...
            <form onSubmit={handleSubmit} className='flex flex-col gap-8'>
                ...
                <div className='flex gap-2 flex-wrap items-center'>
                    ...
                    <div className='flex gap-2'>
                        <input checked={sidebardata.type === 'all'} type='checkbox' id='all' className='w-5' onChange={handleChange}/>
                        <span>Rent & Sale</span>
                    </div>
                    <div className='flex gap-2'>
