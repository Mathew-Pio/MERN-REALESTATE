...
export default function Home() {
  ...
  useEffect(() => {
    const fetchOfferListings = async () => {
      try{
        const res = await fetch(`/api/listing/get/listingBySearch?offer=true&limit=3`);
    ...
    const fetchRentListings = async () => {
      try{
        const res = await fetch(`/api/listing/get/listingBySearch?type=rent&limit=3`);
        const data = await res.json();
    ...
    const fetchSaleListings = async () => {
      try{
        const res = await fetch(`/api/listing/get/listingBySearch?type=sale&limit=3`);
        const data = await res.json();
  ...
  return (
    <div>
      ...
      {/* listing results for offer sales and rent */}
        <div className='max-w-8xl mx-auto p-3 flex flex-col gap-8 my-10 items-center justify-center col-lg-4'>
          {
